...
function Footer() {
    ...
    return (
        <motion.div
            ...
            className="z-10 mx-6 mt-24 mb-8 rounded-2xl bg-gradient-to-br
            from-black/90 via-black/80 to-black/90 backdrop-blur-2xl border
             border-white/10 px-8 py-8 shadow-[0_25px_60px_rgba(0,0,0,0.7)] text-white">
