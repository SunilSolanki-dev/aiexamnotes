...
import imgMain from '../assets/img1.png'
  ...
  return (
    <div className='min-h-screen overflow-hidden bg-white text-black'>
        ...
        <div>
          ...
          >
            ...
            <motion.h1
              ...
              className="text-5xl lg:text-6xl font-extrabold leading-tight bg-gradient-to-br
      ...
      <section className='max-w-6xl mx-auto px-8 py-32 grid grid-cols-1 md:grid-cols-4 gap-10'>
        ...
        <Feature icon="📊" title={"Diagrams"} des="Auto-genrated visual diagrams for clarity " />
