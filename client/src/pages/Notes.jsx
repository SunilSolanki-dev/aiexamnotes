    ...
    <div className='min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 px-6 py-8'>
      <motion.header
        ...
        <div onClick={() => navigate("/")} className='cursor-pointer' >
          <h1
            className='texx-2xl font-bold bg-linear-to-r from-white via-gray-300 
        to-white bg-clip-text text-transparent'>Sagewell AI</h1>
       ...
       border border-white/10 border border-white/20 text-white text-sm'>
            ...
            <motion.span
              ...
              whileTap={{ scale: 0.97 }}
              className='ml-2 h-5 w-5 flex item-center justify-center rounded-full bg-white text-black text-xs font-blod'
            >
              ➕
      ...
      {!result && <motion.div
       ...
       justify-center bg-white/60 backdrop-blur-lg border border-dashed border-gray-300 text-gray-500 shadow-inner'>

        <span className='text-4xl mb-3'>
          📋
        </span>
        <p>Genrateed notes will appear here </p>
